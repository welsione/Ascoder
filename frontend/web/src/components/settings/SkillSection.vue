  ...
  <section class="surface-panel settings-block">
    <div class="section-heading">
      ...
      <div class="section-actions">
        <el-button
          type="primary"
          :plain="showCreateSkill"
          :aria-expanded="showCreateSkill"
          aria-controls="skill-create-panel"
          @click="showCreateSkill = !showCreateSkill"
        >
          <Plus class="button-icon" aria-hidden="true" :size="16" :stroke-width="1.8" />
          {{ showCreateSkill ? '收起' : '添加 Skill' }}
        </el-button>
      </div>
    </div>

    <el-collapse-transition>
      <div v-if="showCreateSkill" id="skill-create-panel" class="skill-create-panel">
